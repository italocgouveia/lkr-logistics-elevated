...
const BRANDS = ["TechFoods", "IndustriMax", "Vale Verde", "LogPrime", "NorteSul", "BRCargo", "Solaris", "PortoRio"];
    ...
    >
      <div className={`mx-auto max-w-7xl px-6 flex items-center justify-between transition-all duration-500 ${scrolled ? "h-16" : "h-20"}`}>
        <a href="#home" className="flex items-center gap-2 group">
          <div
            className="h-10 w-10 rounded-lg grid place-items-center transition-transform duration-500 group-hover:rotate-6"
            style={{ background: "var(--gradient-primary)" }}
          >
            <Truck className="h-5 w-5 text-white" />
          </div>
          <div className={`font-display font-extrabold text-lg leading-none transition-colors ${scrolled ? "text-primary" : "text-white"}`}>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 left-6 bg-white rounded-xl shadow-lg border border-border px-5 py-4 flex items-center gap-3">
              ...
              <div>
                ...
                <div className="font-bold text-primary text-sm">ISO 9001 · ANTT</div>
              </div>
            </div>
          </div>
        </Reveal>
        ...
        <div className="mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {items.map((s, i) => (
            <Reveal key={s.t} delay={i * 70}>
              <div className="group relative rounded-2xl bg-card border border-border p-6 tilt-card overflow-hidden h-full">
                ...
                <div
                  className="relative h-12 w-12 rounded-xl grid place-items-center transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6"
                  style={{ background: "var(--gradient-primary)" }}
                >
                  <s.icon className="h-6 w-6 text-white" />
                </div>
                <h3 className="relative mt-5 font-bold text-lg text-primary">{s.t}</h3>
                <p className="relative mt-2 text-sm text-muted-foreground leading-relaxed">{s.d}</p>
                <div className="relative mt-5 flex items-center gap-1 text-accent text-sm font-semibold opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all">
